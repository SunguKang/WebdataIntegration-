...
dataset.addAttribute(Movie.PLATFORM);
dataset.addAttribute(Movie.PUBLISHERS);
dataset.addAttribute(Movie.PUBLICATIONDATE);
dataset.addAttribute(Movie.GLOBALLYSOLDUNITS);
dataset.addAttribute(Movie.GENRES);
dataset.addAttribute(Movie.CRITICSCORE);
dataset.addAttribute(Movie.USERSCORE);
dataset.addAttribute(Movie.DEVELOPERS);
dataset.addAttribute(Movie.SUMMARY);
dataset.addAttribute(Movie.RATING);
dataset.addAttribute(Movie.SERIES);
