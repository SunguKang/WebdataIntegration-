...
public class SeriesFuserVoting extends AttributeValueFuser<String, Game, Attribute> {

    public SeriesFuserVoting() {
	...
	public void fuse(RecordGroup<Game, Attribute> group, Game fusedRecord, Processable<Correspondence<Attribute, Matchable>> schemaCorrespondences, Attribute schemaElement) {
		...
		fusedRecord.setSeries(fused.getValue());
		fusedRecord.setAttributeProvenance(Game.SERIES, fused.getOriginalIds());
	}
